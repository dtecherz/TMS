...
export const getProducts = async (params, page,sort) => {
  const queryString = params.startsWith('?') ? params.slice(1) : params; // Remove leading '?'
  try {
    return await CallAPI("GET", `api/products/get?${queryString}&page=${page}&price=${sort}`);
  } catch (error) {
    throw error;
  }
};
...
export const updateProduct = async (id, body) => {
  ...
  try {
    ...
    return await CallAPI('POST', `api/products/update-product/${id}`, body)
  } catch (error) {
    throw error;
  }
};
...
export const cartsGet = async (body) =>{
  try {
    return await CallAPI("POST",`api/cart/get-carts`,body)
  } catch (error) {
    throw error
  }
}
...
export const DeleteCartItem = async (body) => {
  console.log()
  try {
    return await CallAPI("POST", `api/cart/delete-cart-item`, body);
  } catch (error) {
    throw error;
  }
};
...
// order place api for guest user 

export const orderPlace = async (body) => {
  // try {
  //   return await CallAPI('POST',`api/order/place-order-guest`,body)
  // }
  try {
    return await CallAPI('POST', `api/order/place-order-guest`, body)
  }
...
export const getGuestUserOrders = async (page,email)=>{
  try {
    return await CallAPI("GET", `api/order/get-guest-user-order/?page=${page}&email=${encodeURIComponent(email)}`);
  } catch (error) {
    console.log(error)
    throw error
  }
...
export const addPaymentMethod = async (body) => {
  try {
    return await CallAPI("POST", `api/payments/add-payment-method`, body)
  } catch (error) {
    throw error
  }
}
...
export const UpdatePaymentMethod = async (id, body) => {
  try {
    return await CallAPI('PUT', `api/payments/update-payment-method/${id}`, body)
  } catch (error) {
    throw error
...
export const AddShipingMethod = async (id) => {
  try {
    return await CallAPI("POST", `api/payments/delete-payment-method/${id}`)
  } catch (error) {
    throw error
